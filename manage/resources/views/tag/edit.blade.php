...
<div class="card">
    <div class="card-body">
        <form action="{{route($route.'update', $tag->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-sm-2">
                    <div class="image-wrapper">
                        <div class="lfm-image-preview"
                            style="--image:url('{{ ($tag->image? url($tag->image) : asset('images/no-image.png') ) }}')">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="image" type="text"
                                ...
                                value="{{ ($tag->image ? $tag->image : old('image')) }}"
            ...
            <div class="form-group">
                ...
                <input id="name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                    name="name"
                    value="{{ (old('name') ? old('name') : ($tag->name ? $tag->name : old('name') ) ) }}"
            ...
            <div class="form-group">
                ...
                <textarea name="content"
                    class="summernote">{{ (old('content') ? old('content') : ($tag->content ? $tag->content : old('content') ) ) }}</textarea>
            </div>
