        ...
        <form action="{{route($route.'update', $user->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-1">
                <div class="col-sm-2">
                    <div class="avatar-wrapper">
                        <img id="holder" class=""
                            src="{{(!$user->avatar ? asset('images/no-avatar.png') : url($user->avatar) )}}">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="avatar" type="text"
                                ...
                                value="{{ $user->avatar }}" placeholder="Chose the avatar" readonly>
                        </div>
            ...
            <div class="form-group">
                ...
                <input id="name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                    name="name" value="{{ $user->name }}" placeholder="Enter the name" autofocus>
            ...
            <div class="form-group">
                ...
                <input id="email" type="email" class="form-control form-control-sm @error('email') is-invalid @enderror"
                    name="email" value="{{ $user->email }}" placeholder="Enter the email" readonly>
